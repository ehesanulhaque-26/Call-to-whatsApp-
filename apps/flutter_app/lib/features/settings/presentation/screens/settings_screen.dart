        ...
        children: [
              ...
              ListTile(
                leading: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isConnected ? AppColors.success.withOpacity(0.1) : AppColors.textTertiary.withOpacity(0.1),
                ...
                subtitle: Text(
                  isConnected ? (connection?.phone ?? 'Connected') : 'Not connected',
                  style: TextStyle(color: isConnected ? AppColors.success : AppColors.textSecondary),
                ),
                trailing: Container(
          ...
          _buildSection(
            ...
            children: [
              ...
              ListTile(leading: const Icon(Icons.lock_outline), title: const Text('Security'), onTap: () {}),
            ],
          ),
          _buildSection(
            context,
            ...
            children: [
              ListTile(
                leading: Container(
                  ...
                  height: 40,
                  decoration: BoxDecoration(
                    color: whatsAppState.openWAHealthy ? AppColors.success.withOpacity(0.1) : AppColors.error.withOpacity(0.1),
                    borderRadius: BorderRadius.circular(AppRadius.md),
                  ),
                  child: Icon(
                    whatsAppState.openWAHealthy ? Icons.cloud_done : Icons.cloud_off,
                    color: whatsAppState.openWAHealthy ? AppColors.success : AppColors.error,
                  ),
                ),
                title: const Text('Backend Status'),
                subtitle: Text(
                  whatsAppState.openWAHealthy ? 'Operational' : 'Unavailable',
                  style: TextStyle(color: whatsAppState.openWAHealthy ? AppColors.success : AppColors.error),
                ),
                trailing: Container(
                  width: 12,
                  height: 12,
          ...
          _buildSection(
            ...
            title: 'Preferences',
            children: [
              ListTile(leading: const Icon(Icons.palette_outlined), title: const Text('Appearance'), onTap: () {}),
